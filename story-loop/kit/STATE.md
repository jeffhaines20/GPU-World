...
| Premises generated | 28 | 24 | budget for M1: twenty-four, and four more for one regenerated cell |
| Probe passages | 10 | 6 | budget for M1: six probes for the six cards chosen at step 6, and four more so that one regenerated cell can be probed too. Sized for the send-back G1 offers the human |
| Premise-judge calls | 16 | 8 | budget for M1: two judges over four batches of six cards is eight calls, two more over the probed six is ten; four more so that a regenerated cell's cards can be judged and then re-judged with their probe. Sized for the send-back G1 offers the human |
