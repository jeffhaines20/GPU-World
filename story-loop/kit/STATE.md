...
| Tokens, whole project | 10M | 7.2M | the human's allowance: 2M in the handoff, raised to 10M in chat at intake (DEC-008) after the dry run measured what a round costs here. Used is an estimate: the orchestrator's own context plus every sub-agent's reported tokens; 1.4M was spent on the day-one fix, the dry run and intake; about 3.3M on two premise passes; about 2.2M on the questions-first funnel (DEC-015), of which the eleven revisers were 1.02M |
