...
**Milestone:** M0 — Intake · **Updated:** _(date)_ · **Current draft:** none
...
| Revision rounds in M3 | 12 | 0 | budget for M3; resets never |
...
| Tokens, whole project | 8M | 0 | the human's allowance. A token is about three quarters of a word of everything the agents read and write; 8M is a full run — the funnel, a first draft, and twelve revision rounds with their critics — with room to spare |
