...
**Milestone:** M2 — The spine · **Updated:** 2026-09-26 · **Kit B (DEC-020): story B, O-2 Working Height.** The caps table and the token count of the whole project are kept in `../kit/STATE.md` and mirrored here; the human's channel is `../kit/INBOX.md` · **Current draft:** none
...
| Tokens, whole project | 15M | 12.2M | the human's allowance: 2M in the handoff, raised to 10M in chat at intake (DEC-008) after the dry run measured what a round costs here, and to 15M at G1 (DEC-019) so that two spines and two first drafts can be written. Used is an estimate: the orchestrator's own context plus every sub-agent's reported tokens; 1.4M was spent on the day-one fix, the dry run and intake; about 3.3M on two premise passes; about 2.2M on the questions-first funnel (DEC-015), of which the eleven revisers were 1.02M; about 2.4M so far on the outline pass (DEC-016), of which 0.5M is an estimate for five reviser calls the account's usage limit cut short without a usage report. The round-2 reviews cost 0.22M. M2 for two stories cost about 2.3M (two architects, two revisions, eight critic calls, two reissues; two architect runs the usage limit cut short are carried as an estimated 0.15M). About 2.8M is left at G2; two first drafts with their first critic and comparison rounds need 2.2 to 3.4M, so both do not fit in full |
